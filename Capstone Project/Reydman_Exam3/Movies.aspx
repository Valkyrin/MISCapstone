...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Pub_Title], [Pub_Date], [Pub_Price], [Pub_Qty] FROM [Movies]" OnSelecting="SqlDataSource1_Selecting"></asp:SqlDataSource>
</asp:Content>