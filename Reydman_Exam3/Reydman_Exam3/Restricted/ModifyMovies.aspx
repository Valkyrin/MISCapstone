...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [Movies] WHERE [Pub_ID] = @original_Pub_ID AND (([Pub_Title] = @original_Pub_Title) OR ([Pub_Title] IS NULL AND @original_Pub_Title IS NULL)) AND (([Pub_Date] = @original_Pub_Date) OR ([Pub_Date] IS NULL AND @original_Pub_Date IS NULL)) AND (([Pub_Price] = @original_Pub_Price) OR ([Pub_Price] IS NULL AND @original_Pub_Price IS NULL)) AND (([Pub_Qty] = @original_Pub_Qty) OR ([Pub_Qty] IS NULL AND @original_Pub_Qty IS NULL))" InsertCommand="INSERT INTO [Movies] ([Pub_Title], [Pub_Date], [Pub_Price], [Pub_Qty]) VALUES (@Pub_Title, @Pub_Date, @Pub_Price, @Pub_Qty)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [Movies]" UpdateCommand="UPDATE [Movies] SET [Pub_Title] = @Pub_Title, [Pub_Date] = @Pub_Date, [Pub_Price] = @Pub_Price, [Pub_Qty] = @Pub_Qty WHERE [Pub_ID] = @original_Pub_ID AND (([Pub_Title] = @original_Pub_Title) OR ([Pub_Title] IS NULL AND @original_Pub_Title IS NULL)) AND (([Pub_Date] = @original_Pub_Date) OR ([Pub_Date] IS NULL AND @original_Pub_Date IS NULL)) AND (([Pub_Price] = @original_Pub_Price) OR ([Pub_Price] IS NULL AND @original_Pub_Price IS NULL)) AND (([Pub_Qty] = @original_Pub_Qty) OR ([Pub_Qty] IS NULL AND @original_Pub_Qty IS NULL))">
        <DeleteParameters>
